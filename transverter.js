(function(){
	...
	simplified_chinese += '恒致征折向舍千累困肮板表采杆琅狸刹台凶岩症注着锛镔铖钏镄擀睾镓钜镘麽铌鲶铩谑芸锺垅吒彷馀宁槔飚溜锘锝锪镅曲';
	traditional_chinese += '恆緻徵摺嚮捨仟纍睏骯闆錶採桿瑯貍剎臺兇巖癥註著錛鑌鋮釧鐨搟睪鎵鉅鏝麼鈮鯰鎩謔蕓鍾壠咤徬餘寧橰飈霤鍩鍀鍃鎇麯';
	var words = {
		'台风':'颱风',
		'度假':'渡假'
	};
	...
	window.transverter = function(parameter){
		var options = {
			type:'simplified',
			str:'',
			language:''
